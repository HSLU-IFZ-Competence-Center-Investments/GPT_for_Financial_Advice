...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange(event) {
    ...
    if (!this.currentVariant) {
      ...
      this.updateMedia();
      this.updateurl("./global_v_106116626045777747121706862504.js.mjs");
      this.updateVariantInput();
      this.renderProductInfo();
      this.updateShareurl("./global_v_106116626045777747121706862504.js.mjs");
    }
  }
  ...
  updateurl("./global_v_106116626045777747121706862504.js.mjs") {
    if (!this.currentVariant || this.dataset.updateUrl === 'false') return;
    window.history.replaceState({}, '', `${this.dataset.url}?variant=${this.currentVariant.id}`);
  }

  updateShareurl("./global_v_106116626045777747121706862504.js.mjs") {
    const shareButton = document.getElementById(`Share-${this.dataset.section}`);
    if (!shareButton || !shareButton.updateUrl) return;
    shareButton.updateurl("./window.shopUrl_this.dataset_variant_this.currentVariant.id.url.html");
  }
